...
link "$repo_dir/lazydocker/config.yml" "$HOME/.config/lazydocker/config.yml"
link "$repo_dir/rainfrog/rainfrog_config.toml" "$HOME/.config/rainfrog/rainfrog_config.toml"
...
link "$repo_dir/yazi/flavors/rose-pine.yazi" "$HOME/.config/yazi/flavors/rose-pine.yazi"
link "$repo_dir/eza/theme.yml" "$HOME/.config/eza/theme.yml"
link "$repo_dir/starship/starship.toml" "$HOME/.config/starship.toml"
link "$repo_dir/git/config" "$HOME/.config/git/config"
link "$repo_dir/git/ignore" "$HOME/.config/git/ignore"
link "$repo_dir/mise/config.toml" "$HOME/.config/mise/config.toml"
link "$repo_dir/agent-of-empires/config.toml" "$HOME/.config/agent-of-empires/config.toml"
link "$repo_dir/posting" "$HOME/.config/posting"
link "$repo_dir/posting/themes/rose-pine.yaml" "$HOME/.local/share/posting/themes/rose-pine.yaml"
link "$repo_dir/tuicr" "$HOME/.config/tuicr"
link "$repo_dir/spicetify/Themes/RosePine" "$HOME/.config/spicetify/Themes/RosePine"
link "$repo_dir/tmux/.tmux.conf" "$HOME/.config/tmux/tmux.conf"
