return {
	{ -- LSP Configuration & Plugins
		...
		dependencies = {
			-- Automatically install dependencies for managing LSP servers
		...
		config = function()
				...
				callback = function(event)
					...
					if client and client.server_capabilities.documentHighlightProvider then
						local highlight_augroup =
							vim.api.nvim_create_augroup("default-lsp-highlight", { clear = false })
			...
			--  Available keys for each server include:
			...
			-- NOTE: To check the current status of installed tools and/or manually install
